...
def execute():
	...
	frappe.reload_doc("upande_webshop", "doctype", "website_item")
	frappe.reload_doc("upande_webshop", "doctype", "website_item_tabbed_section")
	frappe.reload_doc("upande_webshop", "doctype", "website_offer")
	frappe.reload_doc("upande_webshop", "doctype", "recommended_items")
	frappe.reload_doc("upande_webshop", "doctype", "webshop_settings")
