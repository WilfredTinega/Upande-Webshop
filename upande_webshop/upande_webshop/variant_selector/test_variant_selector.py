...
from upande_webshop.upande_webshop.variant_selector.utils import get_next_attribute_and_values
...
class TestVariantSelector(FrappeTestCase):
	...
	def test_item_attributes(self):
		...
		"""
		from upande_webshop.upande_webshop.variant_selector.utils import get_attributes_and_values
	...
	def test_exact_match_with_price(self):
		...
		"""
		from upande_webshop.upande_webshop.doctype.website_item.test_website_item import make_web_item_price
