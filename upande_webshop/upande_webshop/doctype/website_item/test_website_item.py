...
from upande_webshop.upande_webshop.doctype.webshop_settings.test_webshop_settings import (
...
from upande_webshop.upande_webshop.doctype.override_doctype.item import DataValidationError
from erpnext.stock.doctype.item.test_item import make_item
from upande_webshop.upande_webshop.doctype.override_doctype.item_group import get_parent_item_groups
...
class TestWebsiteItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from upande_webshop.upande_webshop.doctype.website_item.website_item import on_doctype_update
