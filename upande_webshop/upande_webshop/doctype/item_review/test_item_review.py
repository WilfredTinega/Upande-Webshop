...
from upande_webshop.upande_webshop.doctype.item_review.item_review import (
	UnverifiedReviewer,
	add_item_review,
	get_item_reviews,
)
...
class TestItemReview(unittest.TestCase):
	...
	def test_add_and_get_item_reviews_from_customer(self):
		...
		try:
			add_item_review(web_item, "Great Product", 0.8, "Would recommend this product")
		...
		# 0.8 fraction == 4 stars, so 100% of reviews fall in the 4-star bucket (index 3)
