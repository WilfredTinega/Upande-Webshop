...
from upande_webshop.upande_webshop.doctype.override_doctype.item_group import invalidate_cache_for
...
class WebshopItem(Item):
    def on_update(self):
        ...
        super().on_update()  # Consider removing duplicate call if not needed
