...
# ERPNext uses in its own CI — the MariaDB service is created fresh for the run
# and torn down after it, so nothing here is a real secret.
...
bench get-app upande_webshop "${GITHUB_WORKSPACE}"
